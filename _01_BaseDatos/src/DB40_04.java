...
public class DB40_04 {
    public static void main(String[] args) {

        // Crear una instancia de la clase File para el archivo "db.yap"
        ...
        // Abrir o crear una base de datos db4o con el archivo "db.yap"
        ObjectContainer db = Db4oEmbedded.openFile(Db4oEmbedded.newConfiguration(), "db.yap");

        // Crear instancias de la clase AlumnoCFGS
        ...
        // Almacenar instancias de AlumnoCFGS en la base de datos
        db.store(a1);
        db.store(a2);
        db.store(a3);
        db.store(a4);
